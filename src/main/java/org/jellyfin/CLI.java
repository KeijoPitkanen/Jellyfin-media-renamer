...
public class CLI extends TerminalCommands {
  /*
   * NOTES
   * 1.HashMap might be dumb for this. Might be better to use a stack
   * datastructure or something
   */
  /*
  ...
  public void runProgram() {
    ...
    // For testing purposes homepath will be set in here
    // homePath = "/home/skula/test/activeTesting";
    System.out.println("Filepath to media folder: " + homePath);
